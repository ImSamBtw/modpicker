...
def build_status(results, sources, offers, reviews, history):
    return {
      'ok': True,
...
def main():
    parts=load('data/seed/parts.json',[])
    ...
    status=build_status(results,sources_json,offers_json,review_json,history)
